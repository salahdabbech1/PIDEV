...
public class TactorController implements Initializable {
  ...
  @FXML
    ...
    private void ModifyRow() throws SQLException {
        ...
        else{Tactor t = new Tactor(TableActors.getSelectionModel().getSelectedItem().getId(), FieldName.getText(),FieldBorn.getValue(),FieldDesc.getText(),"images/tactors/"+FileChooser());
        ServiceTactor st= new ServiceTactor();
        st.update(t);
...
/*        ColID.setCellValueFactory(new PropertyValueFactory<>("id"));
    ...
    public void insertTactor() throws SQLException{
        ...
        Tactor t = new Tactor(null, FieldName.getText(),FieldBorn.getValue(),FieldDesc.getText(),"images/tactors/"+FileChooser());
        ServiceTactor st= new ServiceTactor();
        st.add(t);
        Alert alert = new Alert(Alert.AlertType.INFORMATION);
 ...
 @FXML
    ...
    String FileChooser(){
        ...
        fc.setInitialDirectory(new File("C:\\Users\\bouyo\\Desktop\\Study\\S2\\Project\\JavaFX\\ArtLife\\src\\images\\tactors"));

...
public int Affichertaille() throws SQLException {
 ...
 q.setImage_qr(imageqr);
        QRCodeWriter qrCodeWriter = new QRCodeWriter();
            ...
            try {
              BitMatrix byteMatrix = qrCodeWriter.encode(data,BarcodeFormat.QR_CODE, width, height);
                ...
                if (ImageIO.write(bufferedImage, "png", new File("C:/Users/PersoPc/Desktop/PHP/htdocs/artlife/web/uploads/images/qrproduit/"+code+".png")))
            {
        ...
        String query ="INSERT INTO `event`( `Name`, `idContent`, `idCinema`, `DateDeb`, `Type`, `DateFin`, `Adresse`, `image`, `image_qr`) VALUES (?,?,?,?,?,?,?,?,?)";
...
public static String getMd5(String input) 
    ...
    @Override
    public List<Event> Affichertout() throws SQLException {

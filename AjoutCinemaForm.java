...
updateArrowposition(barGroup.getRadioButton (barGroup.getSelectedIndex()), arrow);
    ...
    addStringValue("name", name);
      ...
      TextField musics =new TextField("", "entrer nombres de salles");
    musics.setUIID("TextFieldBlack");
    addStringValue("nbsalle", musics);
    
    
    TextField trailer =new TextField("", "entrer adresse");
    trailer.setUIID("TextFieldBlack");
    addStringValue("adresse", trailer);
    ...
    Button buttonAjt=new Button("Ajouter Cinema");
    ...
    cinema t=new cinema(String.valueOf(name.getText()).toString(),Integer.parseInt(musics.getText()),String.valueOf(trailer.getText()).toString(),String.valueOf(image.getText()).toString(),String.valueOf(desc.getText()).toString());

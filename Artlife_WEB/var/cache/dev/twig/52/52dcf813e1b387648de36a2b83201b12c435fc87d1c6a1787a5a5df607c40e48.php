...
class __TwigTemplate_f13f3077cf89fae3e4c65ac75e9613c696e55db63c619e6465abe07eea6dcac2 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <p id=\"<?php echo \$view->escape(\$id); ?>_help\" <?php echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$help_attr]); ?>><?php echo \$help; ?></p>
<?php endif; ?>
", "@Framework/Form/form_help.html.php", "C:\\Users\\HP\\Downloads\\ArtLife\\vendor\\symfony\\framework-bundle\\Resources\\views\\Form\\form_help.html.php");
    }
}

 ...
 */
final class Version20210407135436 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX name ON factor');
        $this->addSql('ALTER TABLE factor DROP name, DROP born, DROP description, DROP image, DROP imageb');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE factor ADD name VARCHAR(30) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, ADD born DATE NOT NULL, ADD description TEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, ADD image VARCHAR(70) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, ADD imageb TEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`');
        $this->addSql('CREATE UNIQUE INDEX name ON factor (name)');

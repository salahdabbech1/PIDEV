...
public class Servicecinema {
    ...
    {
        String url=Statics.BASE_URL+"/cinema/addCinema?name=" + t.getName() + "&nbsalle=" + t.getNb_salle() + "&adresse=" +  t.getAdresse() + "&image=" + t.getImg()+"&description="+t.getDesc()+"&rate="+t.getRate(); //création de l'URL
        req.setUrl(url);

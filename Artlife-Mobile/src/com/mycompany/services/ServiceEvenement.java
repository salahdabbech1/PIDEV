...
public static ServiceEvenement instance=null;
    ...
    {
        String url=Statics.BASE_URL+"/event/addEvenement?Name=" + t.getName() + "&idContent=" + t.getIdContent()  + "&idCinema=" + t.getIdCinema()  + "&Datedeb=" + t.getDatedeb()  + "&Type=" + t.getType()  + "&DateFin=" + t.getDateFin() + "&Adresse=" +  t.getAdresse()  + "&image=" + t.getImage()+ "&image_qr=" + t.getImage_qr()  ; //création de l'URL
        req.setUrl(url);
     ...
     public ArrayList<Evenement>AffichageEvenement()
    {
      ...
      String url=Statics.BASE_URL+"/event/displayEvenements";
        req.setUrl(url);
...
//                }
    ...
    public Evenement DetailEvenement(int id,Evenement evenements)
    {
        ...
        String url=Statics.BASE_URL+"/event/detailEvenement?"+id;
        req.setUrl(url);
    ...
    {
        String url=Statics.BASE_URL + "/event/deleteEvenement?id="+id;
        req.setUrl(url);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
...
String url = Statics.BASE_URL+"/event/updateEvenement?id="+ t.getId() +"&Name=" + t.getName() + "&idContent="+ t.getIdContent()  +"&idCinema="+ t.getIdCinema()  +"&DateDeb=" + t.getDatedeb()  + "&Type=" + t.getType()  + "&DateFin=" + t.getDateFin() + "&Adresse=" +  t.getAdresse()  + "&Image=" + t.getImage() + "&image_qr=" + t.getImage_qr();
req.setUrl(url);
req.addResponseListener(new ActionListener<NetworkEvent>() {
public void actionPerformed (NetworkEvent evt) {

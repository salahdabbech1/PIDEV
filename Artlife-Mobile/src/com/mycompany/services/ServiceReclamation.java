...
//                         String Traite=obj.get("traite").toString();
    ...
    public ArrayList<Reclamation> findAll() {
     ...
     public void addReclamation(Reclamation t){
        String url = Statics.BASE_URL +"/reclamation/addReclamation?Titre=" + t.getTitre() + "&Description=" + t.getDescription()   ; 
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
       ...
       public void modifierReclamation(Reclamation t){
        String url = Statics.BASE_URL +"/reclamation/updateReclamation?id="+ t.getId() + "&Description=" + t.getDescription()   +"&Titre=" + t.getTitre()   + "&datere=" +  t.getDatere()  + "&traiter=" + t.getTraiter() ;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
      ...
      public void traiterReclamation(int id){
        String url = Statics.BASE_URL +"/reclamation/traiterReclamation?id="+id;
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override

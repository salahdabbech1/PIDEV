 ...
 * @author HP
 */
public class ListTheatreForm extends BaseForm{
    Form current;
    private EncodedImage placeHolder;
    public ListTheatreForm(Resources res) {
...
RadioButton liste = RadioButton.createToggle("LISTE DES THEATRES", barGroup);
...
//        }
       ...
       // Label ta8 = new Label("Votre Actor :"+u.getTactor());
        ...
        else
        {
            dig.dispose();
       try{
           if(ServiceTheatre.getInstance().deleteTheatre(u.getId()))
        {
        ...
        lModifier.addPointerPressedListener(l->{
           ...
           new ModifTheatreForm(res,u).show();

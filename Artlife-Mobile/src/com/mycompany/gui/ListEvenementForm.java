...
RadioButton liste = RadioButton.createToggle("LISTE DES EVENEMENTS", barGroup);
...
//        Label ta5 = new Label("Votre Trailer :"+u.getTrailer());
//           ImageViewer poster;
//        try {
//        poster = new ImageViewer(getImageFromServer(u.getPoster()));
//        }
//        catch(Exception e) {
//        System.out.println(u.getPoster());
//        poster = new ImageViewer(res.getImage("s.png"));
//        }
        Label ta7 = new Label("Votre Genre :"+u.getIdContent());
        Label ta8 = new Label("Votre Actor :"+u.getIdCinema());
        ...
        else
        {
            dig.dispose();
       try{
           if(ServiceEvenement.getInstance().deleteEvenement(u.getId()))
        {
        ...
        lModifier.addPointerPressedListener(l->{
           ...
           new ModifierEvenementForm(res,u).show();

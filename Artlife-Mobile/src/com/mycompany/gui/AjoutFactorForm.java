 ...
 * @author HP
 */
public class AjoutFactorForm extends BaseBack{
       Form current;
    public AjoutFactorForm(Resources res){
...
updateArrowposition(barGroup.getRadioButton (barGroup.getSelectedIndex()), arrow);
    ...
    Picker born=new Picker();
       born.setUIID("TextFieldBlack");
       addStringValue("Date Born", born);
    
    TextField description =new TextField("", "entrer description");
    description.setUIID("TextFieldBlack");
    addStringValue("description", description);
    
    TextField imageb =new TextField("", "entrer imageb");
    description.setUIID("TextFieldBlack");
    addStringValue("imageb", imageb);
           ...
           addStringValue("", btnAnnuler);
                ...
                new ListFactorForm(res).show();
                  ...
                  CheckBox multiSelect = new CheckBox("Multi-select");
                     Button buttonAjt=new Button("Ajouter Factor");
                //CODE ABAY
    ...
    buttonAjt.addActionListener((ActionEvent e) -> {
                  ...
                  if (multiSelect.isSelected()) {
                    ...
                    if (file == null) {
                        ...
                        if (file.lastIndexOf(".") > 0) {
                            ...
                            try {
                                String namePic ="images/Factors/"+ saveFileToDevice(file, ext);
     ...
     try{
             if(name.getText()=="" || description.getText()==""|| born.getText()==""){
    ...
    Factor t= new Factor(name.getText(), born.getDate(), description.getText(), namePic, imageb.getText());
   ServiceFactor.getInstance().addFactor(t);
     iDialog.dispose(); 
         new ListFactorForm(res).show();
    refreshTheme();
    }

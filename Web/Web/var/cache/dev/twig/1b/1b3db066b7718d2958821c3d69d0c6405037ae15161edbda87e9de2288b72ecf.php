...
/* factor/show.html.twig */
class __TwigTemplate_e99db9682650a7c2e9e4e94bf94b5ae147411493fdfc316f8e9e5f44b9ac2d99 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "factor/show.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "factor/show.html.twig"));
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<img src=\"../wp-content";
        // line 417
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["factor"]) || array_key_exists("factor", $context) ? $context["factor"] : (function () { throw new RuntimeError('Variable "factor" does not exist.', 417, $this->source); })()), "imageb", [], "any", false, false, false, 417), "html", null, true);
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<rs-layer id=\"slider-5-slide-5-layer-0\" data-type=\"text\" data-tsh=\"c:rgba(0,0,0,0.2);h:3px;v:4px;b:10px;\" data-xy=\"y:m;\" data-text=\"w:normal;s:190,190,130,70;l:180,180,120,60;\" data-dim=\"w:616px,616px,616px,333px;\" data-rsp_o=\"off\" data-rsp_bd=\"off\" data-frame_999=\"o:0;st:w;\" style=\"z-index:5;font-family:Bebas Neue;\">";
        // line 418
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["factor"]) || array_key_exists("factor", $context) ? $context["factor"] : (function () { throw new RuntimeError('Variable "factor" does not exist.', 418, $this->source); })()), "name", [], "any", false, false, false, 418), "html", null, true);
        echo "</rs-layer>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<rs-layer id=\"slider-5-slide-5-layer-1\" data-type=\"text\" data-xy=\"y:m;yo:205px,205px,155px,95px;\" data-text=\"w:normal;s:18;l:26;ls:4px;\" data-rsp_o=\"off\" data-rsp_bd=\"off\" data-frame_999=\"o:0;st:w;\" style=\"z-index:6;font-family:Bebas Neue;\">Born in ";
        // line 419
        ((twig_get_attribute($this->env, $this->source, (isset($context["factor"]) || array_key_exists("factor", $context) ? $context["factor"] : (function () { throw new RuntimeError('Variable "factor" does not exist.', 419, $this->source); })()), "born", [], "any", false, false, false, 419)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["factor"]) || array_key_exists("factor", $context) ? $context["factor"] : (function () { throw new RuntimeError('Variable "factor" does not exist.', 419, $this->source); })()), "born", [], "any", false, false, false, 419), "Y/m/d"), "html", null, true))) : (print ("")));
        echo "</rs-layer>
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
        // line 505
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["factor"]) || array_key_exists("factor", $context) ? $context["factor"] : (function () { throw new RuntimeError('Variable "factor" does not exist.', 505, $this->source); })()), "description", [], "any", false, false, false, 505), "html", null, true);
        echo "
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</h2>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
...
<!-- Mirrored from pelicula.qodeinteractive.com/director-home/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Apr 2021 14:42:09 GMT -->
    ...
    {
        return array (  558 => 505,  469 => 419,  465 => 418,  461 => 417,  43 => 1,);
    }
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tvisibility: inherit;
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t}\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<img src=\"../wp-content{{ factor.imageb }}\" alt=\"a\" title=\"h7-slider-img-1\" width=\"1920\" height=\"900\" class=\"rev-slidebg\" data-no-retina>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<rs-layer id=\"slider-5-slide-5-layer-0\" data-type=\"text\" data-tsh=\"c:rgba(0,0,0,0.2);h:3px;v:4px;b:10px;\" data-xy=\"y:m;\" data-text=\"w:normal;s:190,190,130,70;l:180,180,120,60;\" data-dim=\"w:616px,616px,616px,333px;\" data-rsp_o=\"off\" data-rsp_bd=\"off\" data-frame_999=\"o:0;st:w;\" style=\"z-index:5;font-family:Bebas Neue;\">{{ factor.name }}</rs-layer>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<rs-layer id=\"slider-5-slide-5-layer-1\" data-type=\"text\" data-xy=\"y:m;yo:205px,205px,155px,95px;\" data-text=\"w:normal;s:18;l:26;ls:4px;\" data-rsp_o=\"off\" data-rsp_bd=\"off\" data-frame_999=\"o:0;st:w;\" style=\"z-index:6;font-family:Bebas Neue;\">Born in {{ factor.born ? factor.born|date('Y/m/d') : '' }}</rs-layer>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<rs-layer id=\"slider-5-slide-5-layer-10\" data-type=\"shape\" data-xy=\"xo:450px,450px,299px,161px;y:m;yo:-96px,-96px,-62px,-32px;\" data-text=\"w:normal;\" data-dim=\"w:80px,80px,65px,35px;h:15px,15px,12px,8px;\" data-rsp_o=\"off\" data-rsp_bd=\"off\" data-frame_0=\"x:-100%;\" data-frame_0_mask=\"u:t;\" data-frame_1=\"sp:1000;\" data-frame_1_mask=\"u:t;\" data-frame_999=\"o:0;st:w;\" style=\"z-index:7;background-color:#ffffff;\"></rs-layer>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</rs-slide>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</rs-slides>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<rs-static-layers>
...
<!-- Mirrored from pelicula.qodeinteractive.com/director-home/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Apr 2021 14:42:09 GMT -->
</html>", "factor/show.html.twig", "C:\\Users\\bouyo\\Desktop\\Study\\S2\\Project\\Web\\ArtLife\\templates\\factor\\show.html.twig");
    }
}

...
public class ticket {
 ...
 private LocalDate date;
    ...
    public ticket(String idUser,String idCinema,int idSalle,String idEvent,int montant,LocalDate date,String chaise) {
        this.idUser = idUser;
        this.idCinema = idCinema;   
        this.idSalle = idSalle;
        this.idEvent = idEvent;
    ...
    public ticket(int id,String idUser,String idCinema,int idSalle,String idEvent,int montant,LocalDate date,String chaise) {
        this.id = id;
        this.idUser = idUser;
        this.idCinema = idCinema;   
        this.idSalle = idSalle;

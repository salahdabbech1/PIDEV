...
public class Cinema_salleController implements Initializable {
    ...
    private void ajouter_cinema(ActionEvent event) throws SQLException {
          System.out.println(image_field.getText());
   ...
   @FXML
    ...
    @FXML
    private void delete_cinema() throws SQLException{
    ...
    public void SelectRow(){
        ...
        Image im= new Image(tab_cin.getSelectionModel().getSelectedItem().getImg());
        imageC.setImage(im);
    }
    @FXML
 ...
 @FXML
    private void Uploadfile(ActionEvent event) {
         ...
         fc.setInitialDirectory(new File("C:\\Users\\bouyo\\Desktop\\Study\\S2\\Project\\JavaFX\\ArtLife\\src\\images\\Cinema"));
//        String path = fc.showOpenDialog(upload_img.getScene().getWindow()).getPath();
        ...
        image_field.setText("images/Cinema/"+f.getName());
    }
}

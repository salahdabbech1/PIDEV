...
private Duration totalTime;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        listFiles("C:\\Users\\bouyo\\Desktop\\Study\\S2\\Project\\JavaFX\\ArtLife\\src\\music");
     //     playB.setText("play");
          
          Image value = new Image("images/Front/play.png");
          imt.setImage(value);
...
//    imv.setImage(image);
  ...
  //ken déjà there's a sound w nzelet aal bouton hedha yaamel pause
      if ((finale.getStatus()==Status.PLAYING))
     { 
     
        //  playB.setText("pause");
//         Image value = new Image("images/Front/pause.png");
//          imt.setImage(value);
          finale.pause();
        //  playB.setText("play");
        Image value1 = new Image("images/Front/play.png");
          imt.setImage(value1);
...
//          imt.setImage(value);
        ...
        finale.setRate(1);
       // playB.setText("pause");
       Image value1 = new Image("images/Front/pause.png");
          imt.setImage(value1);
        }
...
//***********************************************************************************************//
    ...
    private void tester(MouseEvent event) {
      chansons = listV.getSelectionModel().getSelectedItem();
         path = "C:\\Users\\bouyo\\Desktop\\Study\\S2\\Project\\JavaFX\\ArtLife\\src\\music\\" + chansons + ".mp3";

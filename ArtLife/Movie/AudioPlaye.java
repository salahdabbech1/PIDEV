 ...
 * @author HP
 */
public class AudioPlaye extends Thread {
	 ...
	 */
	public AudioPlaye(File audioFile) throws IOException, UnsupportedAudioFileException {
	 ...
	 * @param ais
	 */
	public AudioPlaye(AudioInputStream ais) {
		this.ais = ais;
	}
	 ...
	 * @throws UnsupportedAudioFileException
	 */
	public AudioPlaye(File audioFile, LineListener lineListener) throws IOException, UnsupportedAudioFileException {
		this.ais = AudioSystem.getAudioInputStream(audioFile);
	 ...
	 * @param lineListener
	 */
	public AudioPlaye(AudioInputStream ais, LineListener lineListener) {
		this.ais = ais;
		this.lineListener = lineListener;
	}
	 ...
	 * @throws UnsupportedAudioFileException
	 */
	public AudioPlaye(File audioFile, SourceDataLine line, LineListener lineListener) throws IOException, UnsupportedAudioFileException {
		this.ais = AudioSystem.getAudioInputStream(audioFile);
		this.line = line;
		this.lineListener = lineListener;
	}
	 ...
	 * @param lineListener
	 */
	public AudioPlaye(AudioInputStream ais, SourceDataLine line, LineListener lineListener) {
		this.ais = ais;
		this.line = line;
		this.lineListener = lineListener;
	}
	 ...
	 */
	public AudioPlaye(File audioFile, SourceDataLine line, LineListener lineListener, int outputMode) throws IOException, UnsupportedAudioFileException {
		this.ais = AudioSystem.getAudioInputStream(audioFile);
		this.line = line;
		this.lineListener = lineListener;
	 ...
	 *            stereo output, or mute the right channel of a stereo signal; if RIGHT_ONLY, do the same with the right output channel.
	 */
	public AudioPlaye(AudioInputStream ais, SourceDataLine line, LineListener lineListener, int outputMode) {
		this.ais = ais;
		this.line = line;
		this.lineListener = lineListener;
		this.outputMode = outputMode;
	...
	/**
	 * Cancel the AudioPlaye which will cause the Thread to exit
	 */
	public void cancel() {
		if (line != null) {
			line.stop();

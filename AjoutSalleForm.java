 ...
 * @author HP
 */
public class AjoutSalleForm extends BaseForm{
         Form current;
    public AjoutSalleForm(Resources res){
...
updateArrowposition(barGroup.getRadioButton (barGroup.getSelectedIndex()), arrow);
    ...
    TextField name =new TextField("", "entrer nombres des chaise");
    name.setUIID("TextFieldBlack");
    addStringValue("NumChaise", name);
    
      
    ComboBox idmusician = new ComboBox();
        for (salle c : new Servicesalle().Affichagesalle()) {
                idmusician.addItem(c.getId_cine());
            }
    addStringValue("idmusician", idmusician); 
    Button buttonAjt=new Button("Ajouter salle");
    ...
    salle t=new salle(Integer.parseInt(idmusician.getSelectedItem().toString()),Integer.parseInt(name.getText()));
    System.out.println("data  = "+t);
    Servicesalle.getInstance().addsalle(t);
    iDialog.dispose(); 

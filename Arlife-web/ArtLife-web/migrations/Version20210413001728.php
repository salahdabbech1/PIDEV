 ...
 */
final class Version20210413001728 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE theatreactors (id INT AUTO_INCREMENT NOT NULL, TactorId INT DEFAULT NULL, TheatreId INT DEFAULT NULL, INDEX TactorId (TactorId), INDEX Fid (TheatreId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE theatreactors ADD CONSTRAINT FK_TactorId FOREIGN KEY (TactorId) REFERENCES tactor (id)');
        $this->addSql('ALTER TABLE theatreactors ADD CONSTRAINT FK_TheatreId FOREIGN KEY (TheatreId) REFERENCES theatre (id)');
        $this->addSql('ALTER TABLE theatre_actors DROP FOREIGN KEY FK_55ABB63C3EBEAB54');
        $this->addSql('ALTER TABLE theatre_actors DROP FOREIGN KEY FK_55ABB63CC80060CD');
        $this->addSql('ALTER TABLE theatre_actors ADD CONSTRAINT FK_55ABB63C3EBEAB54 FOREIGN KEY (tactor_id) REFERENCES tactor (id)');
        $this->addSql('ALTER TABLE theatre_actors ADD CONSTRAINT FK_55ABB63CC80060CD FOREIGN KEY (theatre_id) REFERENCES theatre (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE theatre_actors DROP FOREIGN KEY FK_55ABB63CC80060CD');
        $this->addSql('ALTER TABLE theatre_actors DROP FOREIGN KEY FK_55ABB63C3EBEAB54');
        $this->addSql('ALTER TABLE theatre_actors ADD CONSTRAINT FK_55ABB63CC80060CD FOREIGN KEY (theatre_id) REFERENCES theatre (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE theatre_actors ADD CONSTRAINT FK_55ABB63C3EBEAB54 FOREIGN KEY (tactor_id) REFERENCES tactor (id) ON DELETE CASCADE');

 ...
 */
final class Version20210412234622 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE theatre_actors (theatre_id INT NOT NULL, tactor_id INT NOT NULL, INDEX IDX_55ABB63CC80060CD (theatre_id), INDEX IDX_55ABB63C3EBEAB54 (tactor_id), PRIMARY KEY(theatre_id, tactor_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE theatre_actors');
        $this->addSql('ALTER TABLE film_actors DROP FOREIGN KEY FK_B4D9CDEF567F5183');
        $this->addSql('ALTER TABLE film_actors DROP FOREIGN KEY FK_B4D9CDEFBC88C1A3');
